...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .left-col { padding-top: 8px; padding-right: 6px; }
    ...
    .organization { margin-top: 10px; font-size: 14px; line-height: 1.18; max-width: 302px; }
    .event-block { margin-top: 50px; max-width: 290px; }
    ...
    .signature { margin-top: 40px; max-width: 304px; }
    ...
    .section-title { margin: 10px 0 6px; font-family: "Roboto", Arial, sans-serif; font-size: 14px; font-weight: 700; line-height: 1.16; color: #1E1E1E; }
    .rows { display: grid; gap: 4px; }
    .row { display: grid; grid-template-columns: 22px 290px 1fr 90px; align-items: end; gap: 6px; min-height: 18px; font-family: "Roboto", Arial, sans-serif; }
    .row-prefix, .row-label, .row-score { font-size: 14px; line-height: 1.12; color: #1E1E1E; }
